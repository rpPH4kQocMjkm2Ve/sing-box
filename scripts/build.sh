...
ARM64_TAGS="with_gvisor,with_naive_outbound,with_quic,with_musl,badlinkname,tfogo_checklinkname0"
AMD64_TAGS="with_gvisor,with_naive_outbound,with_quic,badlinkname,tfogo_checklinkname0"
